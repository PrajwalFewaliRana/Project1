...
const Search = () => {
  ...
  return (
    <div
      className={`fixed top-0 left-[74px] w-[29vw] duration-300 transition-all ease-linear rounded-r-2xl z-[1] border-r-[1px] border-[#262626] h-screen opacity-100 bg-black
    ${
      ifSearchState
